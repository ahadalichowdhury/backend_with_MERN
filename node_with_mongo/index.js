...
var URL =
  "mongodb+srv://practice1:practice1@cluster0.b415j.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
...
function InsertData(MyMongoClinet) {
  ...
  var MyData = { name: "hasan", Roll: "02", Class: "Ten", City: "Dhaka" };
...
function DeleteAllItem(MyMongoClient) {
  ...
  MyCollection.deleteMany(function (error, ResultObj) {
    if (error) {
      ...
      console.log("all item are deleted successfully");
    }
  });
}
